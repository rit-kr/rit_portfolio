        ...
        <>
            <div className="container">
                <div className="flex flex-col items-center">
                    <h3 className="font-semibold text-5xl p1/y my-8">Skills</h3>
                    <p className="basis-2/5 text-lg my-8">I confronted the problems of being a non-tech graduate, struggled through the challanges and developed following skills and is now continuously striving to add more to the list.</p>
                </div>
                <div>
